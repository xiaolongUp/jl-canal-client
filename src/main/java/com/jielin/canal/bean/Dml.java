...
/**
 * @author yxl
 * @description DML操作转换对象, com.alibaba.otter.canal.client.adapter.support.dml
...
public class Dml implements Serializable {
    ...
    private Map<String, Integer> sqlType;                                     //字段类型
